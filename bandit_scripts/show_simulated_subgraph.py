...
def add_experiment_argparse(parser: argparse):
    ...
    parser.add_argument(
        "-i", "--iterations", default=3000, type=int, help="Sets the length of the experiment / number of args.iterations (DEFAULT: 3000)"
    )
    parser.add_argument(
        "-f", "--fast-forward-factor", default=50, type=int, help="Sets the fast forward factor (DEFAULT: 50)"
    )
